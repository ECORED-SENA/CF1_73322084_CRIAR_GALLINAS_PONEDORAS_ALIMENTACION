      ...
      .col-lg-12
        .d-flex.flex-column.flex-lg-row.align-items-center.bg-color-6.p-4.rounded-4           
          ...
          .mt-3.mt-lg-0.ps-lg-4            
            a.btn.btn-danger.w-buttons.d-flex.align-items-center.justify-content-center.p-3(:href="obtenerLink('/downloads/Anexos/Anexo_2_Protocolos_Operativos_Estandar_(POE).pdf')" target="_blank")
